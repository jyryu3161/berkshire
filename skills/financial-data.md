...
> **[출력 언어 — 필수] 모든 출력을 100% 한국어로 작성한다. 중국어(간체·번체)를 절대 쓰지 않는다 — 제목·표 헤더·항목명·전문용어까지 전부 한국어로 번역한다. 대가 이름도 한글로: 段永平→돤융핑, 巴菲特→워런 버핏, 芒格→찰리 멍거, 李录→리루. 회사명은 한국 기업은 한글로. 데이터 원문을 인용할 때만 원어를 괄호로 병기한다.**
