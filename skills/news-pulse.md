...
- **description**:
  1. **官方公告**：港交所/SEC/巨潮/DART(한국 dart.fss.or.kr — `tools/dart_data.py disclosures`) 等监管披露平台最近披露
...
- **description**:
  ...
  2. **机构持仓变化**：13F 披露（美股）、港股通持仓、北上资金流向、한국 5%대량보유·기관/외국인 순매매(네이버금융 `tools/krx_data.py`)
